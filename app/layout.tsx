...
export const metadata: Metadata = {
  title: 'アウトドアノート',
  description: 'アウトドア・キャンプ情報',
  keywords: 'アウトドアノート,アウトドア・キャンプ情報',
  openGraph: {
    title: 'アウトドアノート',
    description: 'アウトドア・キャンプ情報',
    type: 'website',
  ...
  return (
    <html lang="ja">
      <head>
        ...
        <script type="application/ld+json" dangerouslySetInnerHTML={{__html:`{"@context": "https://schema.org", "@type": "WebSite", "name": "アウトドアノート", "description": "アウトドア・キャンプ情報", "url": "https://outdoor-note-jp.vercel.app", "publisher": {"@type": "Organization", "name": "AOKAE合同会社", "url": "https://colorpass-web.vercel.app"}, "potentialAction": {"@type": "SearchAction", "target": "https://outdoor-note-jp.vercel.app/blog/{search_term_string}", "query-input": "required name=search_term_string"}}`}} />
      </head>
      <body>{children}
